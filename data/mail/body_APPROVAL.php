<div style="margin: auto; width: 600px; color: rgb(85, 85, 85); padding-right: 20px; padding-left: 20px; font-family: Malgun Gothic; font-size: 13px; background-color: rgb(255, 255, 255);">
    ...
    <div style="margin-bottom: 50px;">
        <div style="color: rgb(68, 68, 68); letter-spacing: -2px; font-size: 32px;">
            <b>회원가입</b>이<br><b>승인</b>되었습니다. <img style="margin-top: -40px; margin-right: 10px; float: right;" alt="mailimg_join top image" src="/data/mail/img/mailimg_join.png">
        </div>
        <div style="line-height: 22px; margin-top: 30px;">
            안녕하세요. {rc_mallNm} 입니다.<br>
            <strong>{rc_memNm}</strong>
            님의
            <strong>{rc_mallNm}</strong>
            회원가입을 축하드립니다. <br> 다양한 상품정보와 함께 언제나 만족스런 쇼핑을 하실 수 있도록 <br> 최선을 다하는 {rc_mallNm}이 되겠습니다. <br> 항상 새롭고 신선한 뉴스와 이벤트로 고객님의 알찬쇼핑을 제안하고자 더욱 열심히 노력하겠습니다. <br>감사합니다.
        </div>
    </div>
    <div style="color: rgb(68, 68, 68); font-size: 15px; font-weight: bold; margin-bottom: 10px;">회원가입 승인정보</div>
    <table class="__se_tbl_ext" style="width: 100%; border-top-color: rgb(181, 181, 181); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;">
        <tbody>
        <tr>
    ...
    <table class="__se_tbl_ext" style="width: 100%; border-top-color: rgb(181, 181, 181); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="width: 50%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;">{rc_smsFl}</td>
            <td style="width: 30%; height: 43px; text-align: right; color: rgb(136, 136, 136); font-size: 12px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;">설정변경일 : {rc_smsLastReceiveAgreementDt}</td>
        </tr>
        <tr>
            ...
            <td style="width: 30%; height: 43px; text-align: right; color: rgb(136, 136, 136); font-size: 12px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;">설정변경일 : {rc_mailLastReceiveAgreementDt}</td>
        </tr>
        </tbody>
    </table>
