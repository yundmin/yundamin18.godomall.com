...
$defaultSkinTree['outline']['side'] = ['_text_' => '측면 디자인','_type_' => 'outSection',];
$defaultSkinTree['outline']['scroll'] = ['_text_' => '스크롤 배너','_type_' => 'outSection',];
...
$defaultSkinTree['board']['skin'] = ['_text_' => '스킨 디자인', '_type_' => 'file',];
$defaultSkinTree['board']['template'] = ['_text_' => '기본 스킨 유형', '_type_' => 'file',];
$defaultSkinTree['service'] = ['_text_' => '고객 서비스', '_type_' => 'file',];
$defaultSkinTree['event'] = ['_text_' => '이벤트 페이지', '_type_' => 'file',];
