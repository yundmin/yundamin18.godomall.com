<?php /* Template_ 2.2.7 2022/12/14 21:08:16 /www/yundamin18_godomall_com/data/skin/front/happykids/outline/_header.html 000010297 */  $this->include_("setBrowserCache","includeFile");
...
<?php }?>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/reset.css')?>">
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/common/common.css')?>">
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/common/layer/layer.css')?>">
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/layout/layout.css')?>">
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/goods/list.css')?>">
	<link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/button.css')?>">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/chosen/chosen.css')?>" />
<?php if($TPL_VAR["gThisPageCss"]){?>
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache($TPL_VAR["gThisPageCss"])?>" />
<?php }?>
    <link type="text/css" rel="stylesheet" href="<?php echo setBrowserCache('/data/skin/front/happykids/css/custom.css')?>" />
...
<?php }?>
    ...
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/gd_gettext.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/jquery.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/underscore/underscore-min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/validation/jquery.validate.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/validation/additional-methods.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/numeral/numeral.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/global/accounting.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/global/money.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/chosen/chosen.jquery.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/placeholder/placeholders.jquery.min.js')?>"></script>
    <![if gt IE 8]>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/copyclipboard/clipboard.min.js')?>"></script>
    <![endif]>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/jquery/vticker/jquery.vticker.js')?>"></script>
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/gd_ui.js')?>"></script>
...
<?php }}?>
    ...
    <script type="text/javascript" src="<?php echo setBrowserCache('/data/skin/front/happykids/js/gd_common.js')?>"></script>
