<div style="margin: auto; width: 600px; color: rgb(85, 85, 85); padding-right: 20px; padding-left: 20px; font-family: Malgun Gothic; font-size: 13px; background-color: rgb(255, 255, 255);">
    ...
    <div style="margin-bottom: 50px;">
        <div style="color: rgb(68, 68, 68); letter-spacing: -2px; font-size: 32px;">
            <b>예치금이</b><br><b>지급</b>되었습니다. <img style="margin-top: -40px; margin-right: 10px; float: right;" alt="deposit-minus top image" src="/data/mail/img/mailimg_deposit-minus.png">
        </div>
        <div style="line-height: 22px; margin-top: 30px;"> 안녕하세요.
            <strong>{rc_mallNm}</strong>
            입니다. <br> {rc_memNm}님께 지급해드린 예치금 내역을 안내드립니다.<br> 예치금은 {rc_mallNm}에서 상품 결제 시 사용하실 수 있습니다.
        </div>
    </div>
    ...
    <table class="__se_tbl_ext" style="width: inherit; border-top-color: rgb(186, 186, 186); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;">
        ...
        <tr>
            <td style="height: 43px; color: rgb(136, 136, 136); padding-right: 20px; padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid; background-color: rgb(243, 243, 243);">지급 예치금</td>
        ...
        <tr>
            <td style="height: 43px; color: rgb(136, 136, 136); padding-right: 20px; padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid; background-color: rgb(243, 243, 243);">지급 후 보유예치금</td>
