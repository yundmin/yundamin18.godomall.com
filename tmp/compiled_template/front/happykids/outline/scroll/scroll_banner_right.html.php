<?php /* Template_ 2.2.7 2022/12/14 21:08:16 /www/yundamin18_godomall_com/data/skin/front/happykids/outline/scroll/scroll_banner_right.html 000005166 */  $this->include_("dataBanner","dataTodayGoods");?>
...
<?php if((is_array($TPL_R2=$TPL_V1)&&!empty($TPL_R2)) || (is_object($TPL_R2) && in_array("Countable", class_implements($TPL_R2)) && $TPL_R2->count() > 0)) {foreach($TPL_R2 as $TPL_V2){?>
        <li>
            <a href="../goods/goods_view.php?goodsNo=<?php echo $TPL_V2["goodsNo"]?>">
                <span class="photo">
                    <img src="<?php echo $TPL_V2["goodsImageSrc"]?>">
                </span>
                <span class="src_box">
...
<?php }?>
            ...
            <button data-goods-no="<?php echo $TPL_V2["goodsNo"]?>" type="button" class="btn_scroll_list_del" title="<?php echo __('최근본 상품에서 삭제')?>"><img src="/data/skin/front/happykids/img/common/btn/btn_scroll_list_del.png" alt="<?php echo __('최근본 상품에서 삭제')?>"></button>
        </li>
<?php }}?>
...
<?php }}?>
    ...
    <div class="scr_paging">
        <button type="button" class="bnt_scroll_prev" title="<?php echo __('최근본 이전 상품')?>"><img src="/data/skin/front/happykids/img/common/btn/btn_scroll_prev.png" alt="<?php echo __('최근본 이전 상품')?>"></button>
        <span><strong class="js_current">0</strong>/<span class="js_total" style="float:none;width:auto;">2</span></span>
        <button type="button" class="bnt_scroll_next" title="<?php echo __('최근본 다음 상품')?>"><img src="/data/skin/front/happykids/img/common/btn/btn_scroll_next.png" alt="<?php echo __('최근본 다음 상품')?>"></button>
    </div>
    <!-- //scr_paging -->
</div>
<span class="btn_scroll_top"><a href="#TOP"><img src="/data/skin/front/happykids/img/common/btn/btn_scroll_top.png" alt="<?php echo __('상단으로 이동')?>"/></a></span>
