...
var gd_member2 = (function ($, _, window, document, undefined) {
    ...
    $.validator.addMethod("alphakornumeric2", function (value, element) {
        return this.optional(element) || !/[^a-zA-Zㄱ-ㅎㅏ-ㅣ가-힣\u119E\u11A2 ,·()\/]/.test(value);
    }, "Letters, numbers, and underscores only please!!!");
    ...
    validate_settings = {
        defaults: {
            ...
            messages: {
                ...
                service: {
                    alphakornumeric2: __("업태를 정확하게 입력해주세요.")
                },
                item: {
                    alphakornumeric2: __("종목을 정확하게 입력해주세요.")
                },
                busiNo: {
                    rangelength: function () {
                ...
                captchaKey: {
                    required: function () {
                        return alert(__('자동등록방지 문자를 입력해주세요.'));
                    }
                }
            },
            errorElement: 'div',
